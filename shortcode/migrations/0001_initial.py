# Generated by Django 4.0.4 on 2022-07-14 12:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ShortCodeSetting',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('generated_count', models.PositiveIntegerField(default=0, help_text='Automatically allocated shortcode count', verbose_name='Generated Count')),
            ],
            options={
