# Generated by Django 3.2.13 on 2022-07-14 07:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='ShortCode',
            fields=[
                ('shortcode', models.CharField(help_text='lowercase short url. Automatically allocated shortcodes are exactly 6-length. User subitted shortcodes are at leat 4-length.', max_length=20, primary_key=True, serialize=False, unique=True, verbose_name='Short URL')),
